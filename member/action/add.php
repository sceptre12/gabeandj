<?php
	...
	if(($_POST['fgname2'] == "") || ( $_POST['lgname2'] =="" )|| ( $_POST['gft2'] == "") || ($_POST['gallergies2'] == "")){
		$fgname2 = $lgname2 = $gft2 = $gallergies2 = null;
	}
	if(($_POST['fgname3'] == "") || ( $_POST['lgname3'] =="" )|| ( $_POST['gft3'] == "") || ($_POST['gallergies3'] == "")){
		$fgname3 = $lgname3 = $gft3 = $gallergies3 = null;
	}
	if(($_POST['fgname4'] == "") || ( $_POST['lgname4'] =="" )|| ( $_POST['gft4'] == "") || ($_POST['gallergies4'] == "")){
		$fgname4 = $lgname4 = $gft4 = $gallergies4 = null;
	}
	if(($_POST['fgname5'] == "") || ( $_POST['lgname5'] =="" )|| ( $_POST['gft5'] == "") || ($_POST['gallergies5'] == "")){
	...
	if((isset($_POST['fname']) && (isset($_POST['lname'])) && (isset($_POST)['email'])) && (isset($_POST['food'])){
		...
		$lgname2 = filter_var($_POST['lgname2'], FILTER_SANITIZE_STRING);
		$gft2 = filter_var($_POST['gft2'], FILTER_SANITIZE_STRING);
		$gallergies2 = filter_var($_POST['gallergies2'], FILTER_SANITIZE_STRING);
		$fgname3 = filter_var($_POST['fgname3'], FILTER_SANITIZE_STRING);
		$lgname3 = filter_var($_POST['lgname3'], FILTER_SANITIZE_STRING);
		$gft3 = filter_var($_POST['gft3'], FILTER_SANITIZE_STRING);
		$gallergies3 = filter_var($_POST['gallergies3'], FILTER_SANITIZE_STRING);
		$fgname4 = filter_var($_POST['fgname4'], FILTER_SANITIZE_STRING);
		$lgname4 = filter_var($_POST['lgname4'], FILTER_SANITIZE_STRING);
		$gft4 = filter_var($_POST['gft4'], FILTER_SANITIZE_STRING);
		$gallergies4 = filter_var($_POST['gallergies4'], FILTER_SANITIZE_STRING);
		$fgname5 = filter_var($_POST['fgname5'], FILTER_SANITIZE_STRING);
		$lgname5 = filter_var($_POST['lgname5'], FILTER_SANITIZE_STRING);
		$gft5 = filter_var($_POST['gft5'], FILTER_SANITIZE_STRING);
	...
	$handler = null;
	header('location:../../specialguest.php');
?>